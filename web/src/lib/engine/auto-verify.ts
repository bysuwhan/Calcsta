...
export interface AutoVerifyModelData {
  ...
  sections: Map<number, { id: number; name: string; a?: number; iz?: number; iy?: number; j?: number; b?: number; h?: number }>;
  materials: Map<number, { id: number; name: string; fy?: number; e?: number }>;
