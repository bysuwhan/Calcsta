...
import { verifySteelElement, type SteelVerification, type SteelDesignParams } from './codes/argentina/cirsoc301';
import type { GoverningPerElement3D } from './governing-case';
import type { MemberDesignResult, DesignCheckSummary } from './design-check-results';
...
import { DESIGN_CODES } from './codes/index';
...
export function getCodeDetail(v: ElementVerification | undefined | null): CodeDetail | null {
   ...
   * inventoried separately rather than treated as verified here.
   */
