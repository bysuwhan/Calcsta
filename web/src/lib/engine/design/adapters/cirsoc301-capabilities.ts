 ...
 *
 * Maintainers reviewed the official publication, but Calcsta does not redistribute it.
 * Unlike CIRSOC 201-2005, the obstacle here is not access to a source edition. Citing the
 * clauses on an unsupported capability is not
