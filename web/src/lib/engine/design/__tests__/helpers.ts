...
export function syntheticBeamContext(over: Partial<MemberContext> = {}): MemberContext {
  ...
  return {
    ...
    material: { fc: 30, fy: 420, cover: 0.025, stirrupDia: 8, maxAggregateSize: { value: 19, origin: 'project', refs: [] } },
    ...
    ...over,
    materialFamily: over.materialFamily ?? 'concrete',
    codeEdition: over.codeEdition ?? '2025',
  };
}
