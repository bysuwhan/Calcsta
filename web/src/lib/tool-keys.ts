 ...
 * did something else.
 *
 * The bindings themselves are the long-standing drawing shortcuts; do not
 * change a letter here without checking it does not collide with the other
 * global shortcuts in KeyboardShortcuts.svelte (H is the axes toggle).
 */
