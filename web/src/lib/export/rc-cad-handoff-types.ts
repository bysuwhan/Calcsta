 ...
 * Coordinates are Calcsta model axes, Z-up right-handed.
 */
 ...
 * a consumer re-render it in its own locale from Calcsta's own dictionary rather than
 ...
 * `CadProvenance` is deliberate rather than an oversight: a check Calcsta did not evaluate has no
...
/** Calcsta has no production geometric containment checker — for any element type. */
