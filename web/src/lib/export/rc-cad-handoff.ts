 ...
 * ── Cover ───────────────────────────────────────────────────────
 *
 * Calcsta exports the footing cover PLACEMENT INTENT it already owns (`Footing.cover`,
...
export function buildRcCadHandoff(
  ...
  // A reported pair carries Calcsta's own classification and the number it was judged
