 ...
 * one. This module is the machine-readable source of that provenance.
 *
...
export interface RegulationInfo {
  ...
  /** True when maintainers verified the implementation against the official edition. */
...
export const REGULATIONS: readonly RegulationInfo[] = [
  ...
  },
  {
    ...
    inForce: null, sourceReviewed: false,
  },
  {
  ...
  },
  {
    ...
    // Reviewed source? No. The app cites CIRSOC 201 26.4 for aggregate limits instead.
  ...
  },
  {
    ...
    inForce: null, sourceReviewed: true,
  },
  {
  ...
  {
    // The reviewed document is Edición Julio 2005. An earlier audit assumed a 2021
    // edition; no 2021 source was reviewed and no 2021 clause number is used anywhere.
