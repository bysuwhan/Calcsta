 ...
 *
 * Maintainers have not reviewed the 2005 edition — `REGULATIONS` records
 * `sourceReviewed: false` for CIRSOC 201-2005. So the rule cannot be implemented: data
 * unavailable from a reviewed source is marked unsupported rather than guessed. This is
 * the same precedent already
 ...
 *
 * To implement 2005 properly: review an authorized copy of CIRSOC 201-2005, then add a
 * SEPARATE evaluator with its own §11.5 clause refs and its own boundary tests. Do not
 * redistribute the publication without permission. Do not parameterise this one — the editions renumber
