...
export const ROLE_CATALOG: readonly RoleOption[] = Object.freeze([
  ...
  {
    // Bindable and EXPERIMENTAL. Maintainers reviewed the official 2018 publication, but no
    // copy of that publication is redistributed with Calcsta and no adapter implements it.
    // A project may therefore declare that it is designed to CIRSOC
    ...
    noteKey: 'regulations.note.sourceReviewedNotImplemented',
  },
  {
