...
const steelEn: Record<string, string> = {
  ...
  'generator.ui.span': 'Span',
  'generator.ui.spanVT': 'Transverse span VT',
  'generator.ui.bayVP': 'Bay spacing VP',
  'generator.ui.frames': 'Frames',
  'generator.ui.clearHeight': 'Clear height PD',
  'generator.ui.rise': 'Ridge rise',
  'generator.ui.endDepth': 'Depth at support',
  'generator.ui.depth': 'Depth between chords',
  'generator.ui.plateau': 'Plateau',
  'generator.ui.panels': 'Panels per half',
  'generator.ui.height': 'Height',
  'generator.ui.width': 'Width',
  ...
  'generator.ui.totals': '{members} members · {nodes} nodes · {length} {unit}',
  ...
  'generator.hint.span': 'The distance between the two supports, in the selected length unit.',
  'generator.hint.rise': 'Height of the ridge above the supports. Zero gives a parallel-chord truss.',
  'generator.hint.endDepth': 'Depth of the truss at the support.',
  'generator.hint.depth': 'Constant depth between chords.',
  'generator.hint.plateau': 'Length of the flat top.',
  'generator.hint.panels': 'Web panels per half. More panels means shorter web members and more joints.',
  'generator.hint.height': 'Total height of the column.',
  'generator.hint.width': 'Distance between the two chords.',
  'generator.hint.divisions': 'Lacing panels along the height.',
  'generator.hint.clearHeight': 'Clear height under the truss.',
  'generator.hint.frames': 'Number of transverse frames. Each is a copy of the frame previewed above.',
  'generator.hint.bayVP': 'Distance between consecutive frames.',
