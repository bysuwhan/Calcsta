/**
 * The ten unoffered dictionaries must not come back into the bundle.
 *
...
describe('the unoffered dictionaries stay out of the application', () => {
  ...
  it('the store imports the four offered dictionaries and their steel companions, and nothing else', () => {
    /*
    ...
    expect(imported).toEqual(['en', 'ko', 'ko-app', 'steel/en']);
  });
});
