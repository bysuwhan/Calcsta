...
describe('editing and reading stay mutually exclusive', () => {
  ...
  it('selection stays armed while a diagram is shown', () => {
    // Panning is a middle-button viewport gesture, so the former pan tool is
    // normalized to select when an old caller or session still asks for it.
