 ...
 * load is a point along a member, and a distributed load is a stretch of one.
 * Treating them all as their member's midpoint — the cheap
...
function loadExtent(
  ...
  // Distributed: the LOADED stretch, which for a partial load is
