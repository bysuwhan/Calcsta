...
/** UI scale correction for the millimetre display system.
 * The stored user multiplier remains unchanged so switching units is reversible. */
export function displayedDiagramScale(kind: DiagramKind, unitSystem: UnitSystem, scale: number): number {
  return kind === 'axial' && unitSystem === 'SI_MM' ? scale * 0.1 : scale;
}
...
const DIAGRAM_COLORS: Record<DiagramKind, { fill: string; stroke: string; text: string }> = {
  moment: { fill: 'rgba(229, 72, 42, 0.5)', stroke: '#e5482a', text: '#f07a62' },
  shear:  { fill: 'rgba(74, 143, 212, 0.5)', stroke: '#4a8fd4', text: '#7fb0e2' },
  axial:  { fill: 'rgba(217, 164, 65, 0.5)', stroke: '#d9a441', text: '#e5bd77' },
};
...
const ENVELOPE_COLORS: Record<DiagramKind, {
  ...
  moment: {
    posFill: 'rgba(229,72,42,0.5)', posStroke: '#e5482a', posText: '#f07a62',
    negFill: 'rgba(74,143,212,0.5)', negStroke: '#4a8fd4', negText: '#7fb0e2',
  },
  shear: {
    posFill: 'rgba(74,143,212,0.5)', posStroke: '#4a8fd4', posText: '#7fb0e2',
    negFill: 'rgba(229,72,42,0.5)',  negStroke: '#e5482a', negText: '#f07a62',
  },
  axial: {
    posFill: 'rgba(217,164,65,0.5)', posStroke: '#d9a441', posText: '#e5bd77',
    negFill: 'rgba(143,163,179,0.5)', negStroke: '#8fa3b3', negText: '#a8b8c6',
  },
};
