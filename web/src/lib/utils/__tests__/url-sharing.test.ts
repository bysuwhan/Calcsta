...
function makeSnapshot(): ModelSnapshot {
  return {
    ...
    elements: [
      [1, { id: 1, type: 'frame', nodeI: 1, nodeJ: 2, materialId: 1, sectionId: 1, releaseI: { my: false, mz: false, t: false }, releaseJ: { my: false, mz: false, t: false } }],
      [2, { id: 2, type: 'frame', nodeI: 2, nodeJ: 3, materialId: 1, sectionId: 1, releaseI: { my: false, mz: false, t: false }, releaseJ: { my: false, mz: false, t: false } }],
      [3, { id: 3, type: 'frame', nodeI: 3, nodeJ: 4, materialId: 1, sectionId: 1, releaseI: { my: false, mz: false, t: false }, releaseJ: { my: false, mz: false, t: false } }],
    ],
    supports: [
...
function toCompact(snapshot: ModelSnapshot): Record<string, unknown> {
  ...
  c.e = snapshot.elements.map(([, v]) => {
    ...
    if (v.releaseI.mz) opt.hs = true;
    if (v.releaseJ.mz) opt.he = true;
  ...
  return {
    ...
    elements: (c.e as any[]).map(a => {
      ...
      return [a[0], {
        ...
        releaseI: { my: false, mz: opt.hs ?? false, t: false },
        releaseJ: { my: false, mz: opt.he ?? false, t: false },
      }];
    }),
...
describe('URL sharing v2', () => {
  it('compact roundtrip preserves model data', () => {
    ...
    // New share payloads carry no product mode metadata.
    expect(restored.analysisMode).toBeUndefined();
  ...
  it('truss elements roundtrip correctly', () => {
    const snapshot = makeSnapshot();
    snapshot.elements = [
      [1, { id: 1, type: 'truss', nodeI: 1, nodeJ: 2, materialId: 1, sectionId: 1, releaseI: { my: false, mz: false, t: false }, releaseJ: { my: false, mz: false, t: false } }],
    ];
  ...
  it('elements with hinges roundtrip correctly', () => {
    const snapshot = makeSnapshot();
    snapshot.elements = [
      [1, { id: 1, type: 'frame', nodeI: 1, nodeJ: 2, materialId: 1, sectionId: 1, releaseI: { my: false, mz: true, t: false }, releaseJ: { my: false, mz: false, t: false } }],
    ];

    const compact = toCompact(snapshot);
    const restored = fromCompact(compact);

    expect(restored.elements[0][1].releaseI?.mz).toBe(true);
    expect(restored.elements[0][1].releaseJ?.mz).toBe(false);
  });
