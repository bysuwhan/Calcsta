    ...
    {#if modelStore.elements.get(elemId)}
      ...
      <div class="property-row">
        ...
        <div class="inline-select">
          ...
          <button class="icon-btn profile-icon-btn" onclick={() => { materialPresetTargetElemId = elemId; showMaterialPresetSelector = true; }} title={t('table.chooseMaterial')}>&#99778880;</button>
      ...
      <div class="property-row">
        ...
        <div class="inline-select">
          ...
          <button class="icon-btn profile-icon-btn" onclick={() => { sectionChangerTargetElemId = elemId; showSectionChanger = true; }} title={t('table.changeSection')}>&#99778880;</button>
