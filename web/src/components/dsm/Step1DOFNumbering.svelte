<script lang="ts">
  ...
  // Basic 2D frame/truss degree-of-freedom labels.
...
<style>
  ...
  .badge-free { background: rgba(127, 212, 204, 0.5); color: var(--st-value); }
  .badge-restr { background: rgba(229, 72, 42, 0.5); color: var(--st-accent); }
</style>
