  ...
  <div class="kp-panel" class:docked={docked}>
    <div class="kp-header">
      ...
      <div class="kp-header-actions">
        <button
          class="kp-quick-btn"
          class:kp-quick-active={uiStore.showNodeLabels}
          title={t('kinematic.toggleNodeIds')}
          onclick={() => { uiStore.showNodeLabels = !uiStore.showNodeLabels; }}>
          N
        </button>
        <button
          class="kp-quick-btn"
          class:kp-quick-active={uiStore.showElementLabels}
          title={t('kinematic.toggleElementIds')}
          onclick={() => { uiStore.showElementLabels = !uiStore.showElementLabels; }}>
          E
        </button>
        <button
          class="kp-quick-btn"
          class:kp-quick-active={uiStore.showLoads}
          title={t('kinematic.toggleLoads')}
          onclick={() => { uiStore.showLoads = !uiStore.showLoads; }}>
          Q
        </button>
...
<style>
  ...
  */
  ...
  .kp-ok { background: rgba(42, 168, 105, 0.5); color: var(--st-ok); border: 1px solid rgba(42, 168, 105, 0.5); }
  .kp-warn { background: rgba(255, 193, 7, 0.5); color: var(--st-warn); border: 1px solid rgba(255, 193, 7, 0.5); }
  .kp-danger { background: rgba(229, 72, 42, 0.5); color: var(--st-accent); border: 1px solid rgba(229, 72, 42, 0.5); }
  ...
  .kp-ok-bg { background: rgba(42, 168, 105, 0.5); color: var(--st-ok); }
  .kp-warn-bg { background: rgba(255, 193, 7, 0.5); color: var(--st-warn); }
  .kp-danger-bg { background: rgba(229, 72, 42, 0.5); color: var(--st-accent); }

  .kp-unconstrained {
    margin: 0.25rem 0;
    padding: 0.3rem 0.4rem;
    background: rgba(229, 72, 42, 0.5);
    border-radius: 4px;
  ...
  .kp-elem-toggle:hover { background: rgba(255, 255, 255, 0.5); }
  .kp-elem-toggle-left {
    font-size: 0.72rem;
    font-weight: 600;
    color: var(--st-text);
  ...
  .kp-elem-badge-ok { background: rgba(42, 168, 105, 0.5); color: var(--st-ok); }
  .kp-elem-badge-hyper { background: rgba(74, 143, 212, 0.5); color: var(--st-info); }
  .kp-elem-badge-mech { background: rgba(229, 72, 42, 0.5); color: var(--st-accent); }

  .kp-elem-body {
    padding: 0.15rem 0.4rem 0.3rem;
    border-top: 1px solid rgba(23, 41, 58, 0.5);
  }
