    ...
    <div class="help-content">
      ...
      <div class="help-columns">
        ...
        <div class="help-col">
          ...
          <div class="shortcut"><kbd>MMB</kbd> {t('help.pan')}</div>
      ...
      <p class="help-credit">
        <a href="https://github.com/bysuwhan/Calcsta" target="_blank" rel="noopener noreferrer">소스 코드</a>
        <span aria-hidden="true">|</span>
        <a href="/LICENSE.txt" target="_blank" rel="noopener noreferrer">AGPL-3.0</a>
        <span aria-hidden="true">|</span>
        <a href="/third-party-notices.txt" target="_blank" rel="noopener noreferrer">제3자 고지</a>
      </p>
      <p class="help-legal">
        Calcsta는 Stabileo를 기반으로 한 비공식 수정판이며, 어떠한 보증도 없이 제공됩니다.
      </p>
    </div>
  </div>
{/if}
