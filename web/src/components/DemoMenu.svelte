<script lang="ts">
   ...
   *
   * `/demo` still opens the shortest one, because it is the direct entry point
   * for someone who has never seen the app. But a user who is
...
<style>
  ...
  /* Example cards keep the same compact layout: name and a number on one line,
